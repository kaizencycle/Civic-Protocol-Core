...
class CivicClient:
    ...
    def __init__(self, base_url: str = "http://localhost:5411", api_key: str | None = None):
        """
    ...
    def add_reflection(self, title: str, body: str, tags: list[str] = None,
                      visibility: str = "private", companion_id: str | None = None) -> Reflection:
        """
    ...
    def list_reflections(self, author: str | None = None, visibility: str | None = None,
                        tags: list[str] | None = None, limit: int = 50, offset: int = 0) -> dict[str, Any]:
        """
    ...
    def add_attestation(self, subject: str, att_type: str, content_hash: str,
                       attester: str | None = None, metadata: dict | None = None) -> Attestation:
        """
    ...
    def list_attestations(self, attester: str | None = None, subject: str | None = None,
                         att_type: str | None = None, limit: int = 50, offset: int = 0) -> dict[str, Any]:
        """
    ...
    def cast_vote(self, proposal_id: str, choice: str, voter: str | None = None,
                 memo: str | None = None) -> Vote:
        """
    ...
    def list_votes(self, proposal_id: str | None = None, voter: str | None = None,
    ...
    def list_cycles(self, date: str | None = None, status: str | None = None,
                   limit: int = 50) -> dict[str, Any]:
        """
    ...
    def get_earn_events(self, address: str, date: str | None = None,
                       limit: int = 50) -> dict[str, Any]:
        """
...
def create_client(base_url: str = "http://localhost:5411", api_key: str | None = None) -> CivicClient:
