...
class TokenVerifier:
    ...
    def verify_token(self, token: str, lab_source: str) -> dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(401, f"Token verification failed: {e.response.status_code}") from e
        except httpx.RequestError as e:
            raise HTTPException(503, f"Lab service unavailable: {str(e)}") from e
    ...
    def verify_civic_id(self, civic_id: str, lab_source: str) -> bool:
        ...
        return bool(civic_id and civic_id.startswith("civic_"))
